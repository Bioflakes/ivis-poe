(function (d3) {
    ...
    const render = data => {
        const title = 'Most Played Classes';

        const xValue = d => d.league;
        const xAxisLabel = 'Classes';

        const yValue = d => d.zombie;
        const yAxisLabel = 'Players';
    ...
    d3.csv('data/MOCK_DATA.csv')//('https://vizhub.com/curran/datasets/temperature-in-san-francisco.csv')
        .then(data => {
            data.forEach(d => {
                d.league = d.league;
                d.zombie = +d.zombie;
